...
* verificationStatus ^comment = "In the scope of the PS and HDR the entered-in-error concept is not allowed."
...
* code.coding[eHDSIAtc] ^short = "Code for allergy or intolerance from the WHO ATC eHDSI subset"
...
* code.coding[DLP_leciva] ^binding.extension.valueString = "AllergyIntolerance DLP"
* code.coding[DLP_leciva] ^binding.description = "Codes for allergy or intolerance from the Cech national drug value set (DLP)."
